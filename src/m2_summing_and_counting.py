...
def run_test_sum_more_cosines():
    ...
    # ------------------------------------------------------------------
    expected = 1.74688  # This is APPROXIMATELY the correct answer.
    answer = sum_more_cosines(6, 83)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    expected = .6168133  # This is APPROXIMATELY the correct answer.
    answer = sum_more_cosines(-50, 25)
...
def sum_more_cosines(m, n):
    ...
    for x in range((n-m)+1):
        sum_cosine = sum_cosine + math.cos(x+m)
    return sum_cosine
